...
export const BlogCardSkeleton = () => {
  return (
    <div className="card bg-white dark:bg-slate-800 shadow-sm bordered">
      <div className="card-body animate-pulse">
        ...
        <div className="items-center hidden sm:flex">
          <div className="inline-flex gap-1">
            <div className="btn-xs btn border-0 bg-slate-200 dark:bg-slate-700 rounded-sm">
          ...
          <div className="btn btn-sm border-0 bg-slate-200 dark:bg-slate-700 rounded-sm ml-auto">
